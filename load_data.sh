...
curl http://127.0.0.1:8091/pools/default/buckets -XPOST -d 'name=product' -u Administrator:$1  -v  -d authType=none -d proxyPort=11219  -d ramQuotaMB=200
/opt/couchbase/bin/cbdocloader -u Administrator -p $1 -n 127.0.0.1:8091 -b product -s 100 product

curl http://127.0.0.1:8091/pools/default/buckets -XPOST -d 'name=purchases' -u Administrator:$1  -v  -d authType=none -d proxyPort=11220  -d ramQuotaMB=200
